...
$pname = "Unique Sympathy Gifts - Savory Flavors";
...
$pimg1 = "sympathy-food-basket.jpg";
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: product-037</p>
                ...
                <div class="col-sm-12 mt-5">
                    ...
                    <p class="cgb-subcopy">There are a select few unique sympathy gifts that are truly loved by those receiving them. We are so thankful for the amazing PA Dutch foods, baked goods, cheeses, and chocolates we have right here in Lancaster, PA. The unique Sympathy Gifts are customized where you can also choose several of the products. It's so much more than that though. Sympathy gifts need to say I am thinking of you.</p>
