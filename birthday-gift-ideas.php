...
<head>
    ...
    <meta name="description" content="Our birthday gift ideas start with our PA Dutch baked goods, gourmet cheeses, chocolates and so much more that we deliver" />
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 022</p>
                    <h3 class="prod-title">"Lancaster Favorites" Birthday Gift Ideas</h3>
                      <span class="price">
                        <span class="prod-price" id='price_per_item' >$89.50</span>
                            ...
                            <span class="prod-rev-nos">36 Reviews</span>
                    </span>
...
In a world where it can be difficult to find the perfect gift, our birthday gift ideas make the process simple and enjoyable. By choosing from our curated selection of treats like whoopie pies, blueberry breads, shoo fly or apple pies, and more, you’re giving a gift that’s not only delicious but also thoughtful. Let our birthday gift ideas inspire you to create a memorable and personalized gift that will bring joy to any birthday celebration.</p>
 ...
 <div class="product-metadata" 
    data-product-id="product-022"
    data-product-name="Birthday Gift Ideas"
    ...
    data-product-qty=""
    data-product-cart_img="custom-gift-baskets-free.jpg" >
</div>
...
<script> var product_details ="Birthday Gift Ideas - Lancaster Favorites <br/>"; </script>
