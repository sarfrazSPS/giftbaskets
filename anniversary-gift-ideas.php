...
<head>
    ...
    <meta property="og:title" content="Anniversary Gift Ideas" />

    <meta property="og:description" content="Our Anniversary gift ideas are filled with delicious Lancaster PA Dutch gourmet foods, chocolates, baked goods and more that we customize to the occasion" />

    <meta property="og:url" content="https://padutchbaskets.com/anniversary-gift-ideas.html"/>

    <meta property="og:site_name" content="PA Dutch Baskets" />

        <meta property="og:image" content="https://padutchbaskets.com/assets/images/products/dutch-traditions/best-anniversary-gift.jpg+" />
    ...
    <meta name="keywords" content="anniversary gift ideas, gift baskets from lancaster pa, unique gift basket ideas, food gift ideas, custom gift baskets, gourmet food baskets, lancaster pa"/>
                    ...
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="product-metadata" 
                                ...
                                data-product-image-1="happy-anniversary-gifts.jpg"
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- images must be on root path in the folder "images" -->
                            <div class="product-metadata" 
                                data-product-id="product-1062"
                                data-product-name="Lancaster Anniversary Gift Ideas"
                                ...
                                data-product-flavor-pie="yes"
                                data-product-flavor-bread="yes"
                                data-product-image-1="anniversary-gifts-ideas.jpg"
                                data-product-image-2=""
                                data-product-image-3=""
                                data-product-image-4=""
                                ></div>
