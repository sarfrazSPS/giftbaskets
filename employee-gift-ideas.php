...
$pname = "Employee Gift Ideas - Lancaster Favorites";
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: product-057</p>
                    <h3 class="prod-title">"Lancaster Favorites" Employee Gift Ideas</h3>
                      <span class="price">
                        <span class="prod-price" id='price_per_item' >$89.50</span>
                            ...
                            <span class="prod-rev-nos">26 Reviews</span>
                    </span>
