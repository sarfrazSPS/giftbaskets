    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/lancaster-favorites/custom-gift-baskets-free.jpg" class="card-img-top" alt="Our birthday gift ideas start with delicious baked goods, homemade jams, beef, and chocolates from Lancaster PA loved by everyone">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/chocolate-lovers/birthday-chocolate-gift.jpg" class="card-img-top" alt="Our Birthday Chocolate Gift comes from the Dutch in Lancaster PA and is one of our most popular gift boxes">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/deluxe-traditions/birthday-gifts-online.jpg" class="card-img-top" alt="When looking for birthday gifts online consider our Amish made gourmet foods, baked goods, chocolates and more known around the world to be the best">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/traditions/unique-birthday-gifts.jpg" class="card-img-top" alt="The Unique birthday gifts we offer include whoopie pies, baked pies, fudge, jams and more from PA Dutch country loved by everyone">
                        <div class="card-body">
            ...
            <div class="row mt-4">
                ...
                <div class="col">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/savory-flavors/best-birthday-gift-baskets.jpg" class="card-img-top" alt="Our Birthday gift the Savory Flavors is our best seller with many PA Dutch gourmet cheeses, foods, baked goods and delicious chocolates">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/dutch-baked-goods/birthday-gift-delivery.jpg" class="card-img-top" alt="We are happy to offer our birthday gift delivery that consist of Amish baked goods and chocolates known around the world for the amazing treats">
                        <div class="card-body">
                ...
                <div class="col">
                   <!--  <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/celebrations/birthday-gift-box.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Birthday Gift Box</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                ...
                <div class="col">
                      <!--<div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/bakers-special/birthday-food-basket.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
