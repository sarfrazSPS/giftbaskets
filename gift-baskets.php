            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/chocolate-lovers/chocolate-lovers-gift-basket.jpg" class="card-img-top" alt="Our chocolate gift baskets are filled with Lancaster PA Dutch chocolates, fudge and delicious baked goods loved by everyone" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/good-ole-treats/unique-gift-baskets.jpg" class="card-img-top" alt="Our very unique gift baskets have rave reviews from those receiving our PA Dutch baked goods, gourmet foods, chocolates and more that we deliver" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/deluxe-traditions/gourmet-basket.jpg" class="card-img-top" alt="With our gourmet gift baskets we offer gourmet cheeses, baked goods, chocolates, fudge and more that we deliver anywhere in the country" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/traditions/food-basket.jpg" class="card-img-top" alt="Our Traditions food basket one of our very popular gift baskets offers whoopie pies, baked goods, brittle and more that everyone loves" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/lancaster-favorites/custom-gift-baskets.jpg" class="card-img-top" alt="We are happy to offer custom gift baskets with our PA Dutch baked goods. Choose certain products and customize to the occasion" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/celebrations/celebrations-gift-basket.jpg" class="card-img-top" alt="We are happy to offer our gift basket delivery with gourmet foods, cheeses, baked goods and chocoaltes that we can ship to most states in the country" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/bakers-special/food-basket.jpg" class="card-img-top" alt="Our Bakers Special food basket offers the most delicious baked goods from the Amish in Lancaster, PA well known for their ability to make the best baked goods" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/savory-flavors/gift-basket-online.jpg" class="card-img-top" alt="Our Savory Flavors best gift baskets is our most popular with baked pies, blueberry bread, brittle, fudge, apple pie and so much more" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/dutch-baked-goods/customized-basket.jpg" class="card-img-top" alt="When looking for the perfect gift delivery consider our Dutch Baked Goods from Lancaster PA that we guarantee they will love and appreciate" loading="lazy" />
                        <div class="card-body">
                ...
                <div class="col col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/dutch-traditions/food-gift-ideas.jpg" class="card-img-top" alt="The gourmet snack basket won't last very long with these baked goods from Lancaster, PA that are loved worldwide" loading="lazy" />
                        <div class="card-body">
