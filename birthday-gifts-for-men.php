...
$pname = "Birthday gifts for Men & Women - Deluxe Traditions";
...
$pimg1 = "birthday-food-basket.jpg";
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: product-029</p>
                    <h3 class="prod-title">"Deluxe Traditions" Birthday gifts for Men & Women</h3>
                      <span class="price">
