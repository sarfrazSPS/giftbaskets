...
<head>
    ...
    <meta property="og:title" content="Birthday Gifts for Men" />

    <meta property="og:description" content="Our birthday gifts for men and women are loved by both with our PA Dutch baked goods, chocolates and more that we deliver"
    <meta property="og:url" content="https://padutchbaskets.com/birthday-gifts-for-men.php"/>

    <meta property="og:site_name" content="PA Dutch Baskets" />

        <meta property="og:image" content="https://www.padutchbaskets.com/assets/images/products/bakers-special/birthday-food-basket.jpg" />
    ...
    <title>Birthday Gifts for Men | Lancaster PA</title>

    <meta name="description" content="Our birthday gifts for men and women are loved by both with our PA Dutch baked goods, chocolates and more that we deliver" />
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <?php echo breadCrumb($app_path, "Birthday Gifts for Men", 2, "birthday-gift-baskets.php", "Birthday Gift Baskets");?>
<section id="" class="mb-5">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-2 small-images-outer">
                            ...
                            <!--4 side images -->
                                ...
                                alt="Our Birthday gifts for men makes shopping for him a breeze with Gift Baskets that include whoopie pies, blueberry bread, fudge, Emmas popcorn and so much more that we can deliver "
                                onmouseover="myFunction(this)"
                                />
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Main images -->
                                    ...
                                    <img  src="assets/images/products/bakers-special/birthday-food-basket.jpg"   alt="Birthday gifts for men can be difficult, not with our delicious PA Dutch baked goods and other gourmet foods that everyone loves"      id="image_box" class="img-responsive"  />
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 029</p>
                    <h3 class="prod-title">"Bakers Special" Birthday gifts for Men & Women</h3>
                      <span class="price">
                                    ...
                                    <div class="services">
                                        ...
                                        <div class="row justify-content-center">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="birthday">
                                                        ...
                                                        <img src="assets/images/tags/birthday2.png" alt="Our best birthday gift baskets with baked goods, cheeses, chocolates and more"  class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag3">
                                                        ...
                                                        <img src="assets/images/tags/birthday3.png" alt="When looking for the birthday gift boxes we offer delicious pies, gourmet cheeses, chocolates, and much more" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="custom-front">
                                                        ...
                                                        <img src="assets/images/tags/birthday4.png" alt="Birthday Gifts for Men can be difficult but we have a gift they love with our PA Dutch gourmet foods and baked goods" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="Tag">
                                                        ...
                                                        <img src="assets/images/tags/birthday5.png" alt="Unique birthday gifts for men and women with baked goods, gourmet cheeses and chocolates" class="circle ">
											  ...
											  <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/happy-birthday.png" alt="Gifts for Men for their birthday with our PA Dutch treats and baked goods" class="circle ">
                                     ...
                                     <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/happy-birthday2.png" alt="0ur customers keep coming back for birthday gifts for men and women for any occasion" class="circle ">
                ...
                <div class="col-sm-12 mt-5">
                    ...
                    <h2 class="cgb-subhead">Birthday Gifts for Men</h2>
                    <p class="cgb-subcopy">Our Birthday Gifts for Men is one that has been purchased more for men than any other gift basket of box we have. It likely has to do with the combination of gourmet cheeses, blueberry bread, chocoaltes and other very popular foods. <p class="cgb-subcopy">We are thankful to live in a part of the country that offers the most delicious foods, cheeses, and baked goods here in Lancaster, PA with the Pennsylvania Dutch foods. Yes we have the whoopie pies baked apple or shoo fly pie, the most delicious blueberry bread (choice of flavor), fudge and as you can see a lot more than that.</p>
 ...
 <div class="product-metadata" 
    data-product-id="product-029"
    data-product-name="Birthday Gifts for Men"
    ...
    data-product-qty=""
    data-product-cart_img="birthday-food-basket.jpg" >
</div>
...
<script> var product_details ="Birthday Gifts for Men - Bakers Special<br/>"; </script>
