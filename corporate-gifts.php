                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            ...
                            <span class="product-price mt-1">$87.50</span>
                            <p class="card-text mb-0 mt-1">AVAILABLE TO SHIP NOW</p>
                            <a href="<?=$app_path;?>best-corporate-gift-ideas.php" class="btn btn-primary favs-btn mt-0">View More</a>
                            <!-- images must be on root path in the folder "images" -->
                            <div class="product-metadata" 
                                data-product-id="product-1067"
                    ...
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a class="mt-2 ps-2"> 31 Reviews</a>

                            </div>
                            <span class="product-price mt-1">$119.50</span>
                            <p class="card-text mb-0 mt-1">AVAILABLE TO SHIP NOW</p>
                            <a href="<?=$app_path;?>corporate-employee-gifts" class="btn btn-primary favs-btn mt-0">View Details</a>
                            <!-- images must be on root path in the folder "images" -->
                            <div class="product-metadata" 
                                data-product-id="product-1068"
                                data-product-name="Corporate Employee Gifts"
                                data-product-price-regular="119.50"
                                data-product-price-sale=""
                                data-product-shipping-price="0"
                                data-product-stars="5"
                                data-product-reviews="31"
                                data-product-flavor-pie="yes"
                                data-product-flavor-bread="yes"
                ...
                <div class="col">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text mb-0 mt-1">AVAILABLE TO SHIP NOW</p>
                            <a href="<?=$app_path;?>gift-ideas-for-clients" class="btn btn-primary favs-btn mt-0">View Details</a>
                            <!-- images must be on root path in the folder "images" -->
                            <div class="product-metadata" 
                                data-product-id="product-1069"
                                data-product-name="Gift Ideas for Clients"
                                ...
                                data-product-flavor-pie="yes"
                                data-product-flavor-bread="yes"
                                data-product-image-1="get-well.jpg"
                                data-product-image-2=""
                                data-product-image-3=""
                                data-product-image-4=""
                                ></div>
                ...
                <div class="col">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- images must be on root path in the folder "images" -->
                            <div class="product-metadata" 
                                data-product-id="product-1070"
                                data-product-name="Gifts for Employees - Anniversary"
                                data-product-price-regular="89.50"
                                data-product-price-sale=""
                                data-product-shipping-price="10"
                                data-product-stars="5"
                                ...
                                data-product-flavor-pie="yes"
                                data-product-flavor-bread="yes"
                                data-product-image-1="corporate-anniversary.jpg"
                                data-product-image-2=""
                                data-product-image-3=""
                                data-product-image-4=""
                                ></div>
