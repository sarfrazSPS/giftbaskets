    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/traditions/unique-sympathy-gifts.jpg" class="card-img-top" alt="Our thoughtful sympathy gifts from the Amish in Lancaster PA offer whoopie pies, baked pies, fudge, chocolates and more that are loved by everyone">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/dutch-traditions/sympathy-gifts-delivered.jpg" class="card-img-top" alt="It's hard to find the right gift to say sorry for your loss. Our PA Durch baked goods are the perfect gift during a difficult time">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/basket-of-treats/personalized-sympathy-gifts.jpg" class="card-img-top" alt="Our personalized sympathy gifts offers whoopie pies, baked goods, chocolates and more that make the perfect comfort food">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/good-ole-treats/sympathy-gift-basket.jpg" class="card-img-top" alt="Finding the right condolence gifts can be difficult but our PA Dutch baked goods are the right gift with comfort foods that are loved by everyone">
                        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/bakers-choice/best-sympathy-gift-baskets.jpg" class="card-img-top" alt="Offering our deepest sympathy with comfort foods like our PA Dutch baked goods from Lancaster PA offers a bright spot during a difficult time">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/bakers-special/sympathy-gift-baskets-free.jpg" class="card-img-top" alt="Our Sympathy gifts from Lancaster PA offer baked pies, whoopie pies, fudge, delicious bluebery bread and so much more">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/deluxe-traditions/sympathy-gifts-ideas.jpg" class="card-img-top" alt="We offer many sympathy gift ideas with a variety of baked goods from PA Dutch country that make the perfect comfort food gift">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/savory-flavors/sympathy-food-basket.jpg" class="card-img-top" alt="PA Dutch offers unique sympathy gifts that include apple or shoo fly pies, whoopie pies, fudge, brittle, gourmet cheeses and more">
                        <div class="card-body">
