    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-2 small-images-outer">
                            ...
                            <!--4 side images -->
                                ...
                                alt="Our gourmet basket is filled with cheeses, gourmet foods, snacks and much more"
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Main images -->
                                    ...
                                    <img  src="assets/images/products/deluxe-traditions/gourmet-basket.jpg"   alt="Our Gourmet Gift Basket is complete with cheeses, chocolates, gourmet foods, and more from Lancaster PA"      id="image_box" class="img-responsive"  />
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: product-013</p>
                    <h3 class="prod-title">Gourmet Gift Baskets</h3>
                    <span class="price">
                                        ...
                                        <div class="row justify-content-center">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/sympathy3.png" alt="our sympathy gourmet gift baskets are loved by everyone and come from Lancaster, PA well known for delicious baked goods" class="circle ">
                ...
                <div class="col-sm-12 mt-5">
                    ...
                    <p class="cgb-subcopy">If your looking for gourmet gift baskets that will be loved by that special person receiving it, you have come to the right place. Those receiving our Gourmet gift baskets love the array of products with flavor that can only be matched right here in Lancaster, PA. The PA Dutch foods here are made with so much care and it shows in every bite. Well known for their whoopie pies, blueberry breads, chocolates, and even cheese, many of these delicious treats are found within this gourmet gift.</p>
                </div>
            </div>
        </div>
    </div>
