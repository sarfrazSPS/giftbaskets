...
$pname = "Get Well Baskets - Savory Flavors";
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: product-047</p>
                    <h3 class="prod-title">Get Well Baskets</h3>
                      <span class="price">
                        <span class="prod-price" id='price_per_item' >$119.50</span>
                            ...
                            <span class="prod-rev-nos">32 Reviews</span>
                    </span>
                ...
                <div class="col-sm-12 mt-5">
                    ...
                    <p class="cgb-subcopy">We always want our Get Well Baskets to be loved by those receiving them. With our Lancaster PA Dutch foods and customization they will. Our get well baskets with our Savory Flavors offers all the popular PA Dutch foods including delicious blueberry bread (Choose Your Flavor) whoopie pie, gourmet cheeses combined with delicious gourmet mustards, chocolates and so much more. This truly is a gift basket you don't stop enjoying for many days.</p>
