...
<head>
    ...
    <meta property="og:title" content="Get Well Baskets " />

    <meta property="og:description" content="Our get well baskets have everyones favorties with whoopie pies, baked pies, fudge, and much more from Lancaster PA Dutch country "
    ...
    <meta property="og:site_name" content="PA Dutch Baskets" />
        ...
        <meta property="og:image" content="https://www.padutchbaskets.com/assets/images/products/savory-flavors/unique-get-well-gifts.jpg" />
    ...
    <title>Get Well Baskets | Lancaster PA</title>

    <meta name="description" content="Our get well baskets have everyones favorties with whoopie pies, baked pies, fudge, and much more from Lancaster PA Dutch country" />

    <meta name="keywords" content="get well baskets, get well soon gift baskets, feel better soon, get well gifts for men, lancaster pa"/>

    <link rel="canonical" href="https://padutchbaskets.com/get-well-baskets.php">
		<!-- Google Tag Manager -->
...
<?php echo breadCrumb($app_path, "Get Well Baskets", 2, "get-well-gift-baskets.php", "Get Well Gift Baskets");?>
...
<section id="" class="mb-5">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-2 small-images-outer">
                            ...
                            <!--4 side images -->
                                ...
                                alt="Our get well baskets are filled with delicious PA Dutch whoopie pies, baked pies, fudge, and other chocolates and loved by eveyone"
                                ...
                                class="img-responsive"
                                src="assets/images/products/savory-flavors/unique-get-well-gifts.jpg"
                                alt="Our variety of Get well Baskets have amazing reviews because of how much they are enjoyed by those receiving our Lancaster, PA baked goods that we deliver "
                                onmouseover="myFunction(this)"
                                />
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Main images -->
                                    ...
                                    <img  src="assets/images/products/savory-flavors/unique-get-well-gifts.jpg"   alt="Our Get well baskets are a great gift for those feeling under the weather, filled with apple pies, blueberry breads and other baked goods from well known Lancaster, PA  "      id="image_box" class="img-responsive"  />
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 048</p>
                    <h3 class="prod-title">"Savory Flavors" Get Well Baskets</h3>
                      <span class="price">
                                    ...
                                    <div class="services">
                                        ...
                                        <div class="row justify-content-center">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="birthday">
                                                        ...
                                                        <img src="assets/images/tags/getwell1.png" alt="Our PA Dutch Get well baskets are unique offering whoopie pies, apple or shoof fly pie, and other baked goods that are loved "  class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag3">
                                                        ...
                                                        <img src="assets/images/tags/getwell2.png" alt="PA Dutch Baskets offers Get well baskets filled with gourmet cheeses, baked goods, fude, and so much more that everyone loves " class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="custom-front">
                                                        ...
                                                        <img src="assets/images/tags/getwell3.png" alt="Get Well Soon gift baskets complete with Amish made baked goods and chocoaltes that are loved around the world" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="Tag">
                                                        ...
                                                        <img src="assets/images/tags/getwell4.png" alt="Get well gift baskets help when someone is feeling under the weather. Comfort foods including baked goods from the PA Dutch are a great gift" class="circle">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/getwell5.png" alt="Say feel better soon with spcecial comfort foods from PA Dutch Country that include delicious pies, and other baked goods" class="circle ">
											  ...
											  <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/getwell6.png" alt="Get well baskets are the perfect gift for those feeling under the weather. Delicious PA Dutch baked goods that are loved by everyone " class="circle ">
                                     ...
                                     <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/thinking-of-you.png" alt="The Savory Flavors get well baskets arew filled with the most popular Lancaster, PA baked goods, chocolates, and other gourmet foods " class="circle ">
                ...
                <div class="col-sm-12 mt-5">
                    ...
                    <h2 class="cgb-subhead">Get Well Baskets</h2>
                    <p class="cgb-subcopy">We always want our Get Well Baskets to be loved by those receiving them. With our Lancaster PA Dutch foods and customization they will.</p> <p class="cgb-subcopy">Our get well baskets with our Savory Flavors offers all the popular PA Dutch foods including delicious blueberry bread (Choose Your Flavor) whoopie pie, gourmet cheeses combined with delicious gourmet mustards, chocolates and so much more. This truly is a gift basket you don't stop enjoying for many days.</p>
 ...
 <div class="product-metadata" 
    data-product-id="product-048"
    data-product-name="Get Well Baskets"
    ...
    data-product-qty=""
    data-product-cart_img="unique-get-well-gifts.jpg" >
</div>
...
<script> var product_details ="Get Well Baskets - Savory Flavors<br/>"; </script>
