...
<!-- End Google Tag Manager (noscript) -->
    ...
    <?php echo breadCrumb($app_path, "Chocolate Gift Boxes", 2, "birthday-gift-baskets.php", "Birthday Gift Baskets");?>
                                        ...
                                        <div class="row justify-content-center">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="birthday">
                                                        ...
                                                        <img src="assets/images/tags/birthday7.png" alt="Very delicious chocolate gift boxes customized for the birthday of that special person"  class="circle ">
...
<!-- do not remove this div, it will be using to pass data -->
 <div class="product-metadata" 
    data-product-id="product-030"
    data-product-name="Chocolate Gift Boxes"
    ...
    data-product-qty=""
    data-product-cart_img="birthday-chocolate-gift.jpg" >
</div>
...
<script> var product_details ="Birthday Chocolate Gift - Chocolate Lovers <br/>"; </script>
