...
$pname = "Sympathy Gift Ideas - Deluxe Traditions";
...
$pimg1 = "sympathy-gifts-ideas.jpg";
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: product-036</p>
                    <h3 class="prod-title">Sympathy Gift Ideas</h3>
                      <span class="price">
