...
<head>
    ...
    <meta property="og:title" content="birthday basket" />

    <meta property="og:description" content="Our birthday basket celebrations offers PA Dutch foods including Blueberry Bread, Fudge, Whoopie Pies, and much more that receives rave reviews from all"
    <meta property="og:url" content="https://padutchbaskets.com/birthday-basket.php"/>

    <meta property="og:site_name" content="PA Dutch Baskets" />

        <meta property="og:image" content="https://www.padutchbaskets.com/assets/images/products/celebrations/birthday-gift-box.jpg" />
    ...
    <title>Birthday Basket | Lancaster PA</title>

    <meta name="description" content="Our birthday basket celebrations offers PA Dutch foods including Blueberry Bread, Fudge, Whoopie Pies, and much more loved by everyone" />

    <meta name="keywords" content="birthday basket, birthday gift baskets, best birthday gift baskets, lancaster pa"/>

    <link rel="canonical" href="https://padutchbaskets.com/birthday-basket.php">
</head>
...
<section id="" class="mt-5 mb-5">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-2 small-images-outer">
                            ...
                            <!--4 side images -->
                                ...
                                src="assets/images/products/celebrations/birthday-gift-box.jpg"
                                alt="When looking for the perfect birthday basket, our PA Dutch baskets are known as the best baked goods, gourmet cheeses, and chocoaltes loved by everyone"
                                ...
                                alt="Our birthday basket celebrations offers delicious blueberry bread, fudge, whoopie pies, and much more that we will deliver"
                                onmouseover="myFunction(this)"
                                />
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Main images -->
                                    ...
                                    <img  src="assets/images/products/celebrations/birthday-gift-box.jpg"   alt="When looking for the perfect birthday basket consider one that is loved by everyone and can be shared as is the case with our gift baskets"      id="image_box" class="img-responsive"  />
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 023</p>
                    <h3 class="prod-title">"Celebrations" Birthday Basket</h3>
                      <span class="price">
                                    ...
                                    <div class="services">
                                        ...
                                        <div class="row justify-content-center">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="birthday">
                                                        ...
                                                        <img src="assets/images/tags/birthday2.png" alt="Delicious birthday basket with baked goods, cheeses, chocolates and more"  class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="Tag">
                                                        ...
                                                        <img src="assets/images/tags/birthday5.png" alt="Our birthday gift ideas are loved by everyone and shipped anywhere in the country" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/birthday6.png" alt="Our birthday basket offers whoopie pies, fudge, blueberry breads, pies and more" class="circle ">
                                     ...
                                     <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/happy-birthday2.png" alt="Our birthday basket ideas offer whoopie pies, fudge, blueberry breads, pies and more" class="circle ">
                ...
                <div class="col-sm-12 mt-5">
                    ...
                    <h2 class="cgb-subhead">Birthday Basket</h2>
                    <p class="cgb-subcopy">We are happy to offer a birthday basket filled with many Lancaster PA baked goods, fudge and more. Our top priority has always been to deliver a qualiity birthday basket customized to your occasion. If you do not see the customization you need, please give us a call and we will get it done for you.
 ...
 <div class="product-metadata" 
    data-product-id="product-023"
    data-product-name="Birthday Basket"
    ...
    data-product-qty=""
    data-product-cart_img="birthday-gift-box.jpg" >
</div>
...
<script> var product_details ="Birthday Basket - Celebrations<br/>"; </script>
