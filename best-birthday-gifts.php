...
$pname = "Best Birthday Gifts - Deluxe Traditions";
...
$pimg1 = "birthday-gifts-online.jpg";
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: product-028</p>
