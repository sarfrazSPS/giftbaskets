...
<head>
    ...
    <meta property="og:title" content="Gift Basket Delivery" />

    <meta property="og:description" content="Our gift basket delivery comes from Lancaster, PA with a wide selection of baked goods, gourmet cheeses, chocoates and more that we deliver" />

    <meta property="og:url" content="https://padutchbaskets.com/gift-basket-delivery.php"/>

    <meta property="og:site_name" content="PA Dutch Baskets" />

        <meta property="og:image" content="https://www.padutchbaskets.com/assets/images/products/celebrations/gift-basket-delivery.jpg" />
    ...
    <title>"Celebrations" Gift Basket Delivery | Lancaster PA</title>

    <meta name="description" content="Our gift basket delivery comes from Lancaster, PA with a wide selection of baked goods, gourmet cheeses, chocoates and more that we deliver" />
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <?php echo breadCrumb($app_path, "Celebrations - Gift Basket Delivery", 2, "gift-baskets.php", "Gift Baskets");?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-sm-2 small-images-outer">
                            ...
                            <!--4 side images -->
                                ...
                                src="assets/images/products/celebrations/gift-basket-delivery.jpg"
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Main images -->
                                    ...
                                    <img  src="assets/images/products/celebrations/gift-basket-delivery.jpg"   alt="Try our gift basket delivery with many baked good, gourmet cheeses, chocoaltes, Emma's famous popcorn and more delivered"      id="image_box" class="img-responsive"  />
                 ...
                 <div class="col-md-6">
                    <p class="prod-id">Product ID: 016</p>
                    <h3 class="prod-title">"Celebrations" Gift Basket Delivery</h3>
                    <span class="price">
                                        ...
                                        <div class="row justify-content-center">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="birthday">
                                                        ...
                                                        <img src="assets/images/tags/birthday4.png" alt="bithday gift basket delivery with PA Dutch baked goods that we deliver"  class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/sympathy3.png" alt="sympathy gift basket delivery filled with delicious PA Dutch foods from the Amish" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="custom-front">
                                                        ...
                                                        <img src="assets/images/tags/get-well5.png" alt="get well gift basket delivery offered with delicious Amish foods, baked goods, cheeses and more with delivery" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="Tag">
                                                        ...
                                                        <img src="assets/images/tags/thank-you2.png" alt="Thank you gift basket delivery with custom gift baskets that can be delivered" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/congrats3.png" alt="congratulations gift basket delivery with cheeses, breads and more" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="balloon">
                                                        ...
                                                        <img src="assets/images/tags/happy-anniversary.png" alt="anniversary gift basket delivery from Lancaster PA" class="circle ">
                                                ...
                                                <div class="col-sm-new-2 mb-new">
                                                    ...
                                                    <label for="tag">
                                                        ...
                                                        <img src="assets/images/tags/thinking-of-you.png" alt="thinking of you gift basket delivery with treats, snacks and foods from Lancaster, PA" class="circle ">
...
Browse our collection today and experience the convenience of our gift basket delivery service to make any occasion special. With our expertly curated selections and dedication to excellence, our gift baskets and gift boxes are sure to impress and bring joy to any recipient. Enjoy the rich flavors and high-quality products that make our baskets a perfect choice for any celebration.</p>
 ...
 <div class="product-metadata" 
    data-product-id="product-016"
    data-product-name="Gift Basket Delivery"
    ...
    data-product-qty=""
    data-product-cart_img="gift-basket-delivery.jpg"
    ></div>
...
<script> var product_details ="Gift Basket Delivery   Celebrations <br/>"; </script>
