...
<head>
    ...
    <meta property="og:url" content="https://padutchbaskets.com/corporate-employee-gifts.php"/>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <?php echo breadCrumb($app_path, "Corporate Employee Gifts", 2, "corporate-gifts.php", "Corporate Gifts");?>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 058</p>
 ...
 <div class="product-metadata" 
    ...
    data-product-qty=""
    data-product-cart_img="congratulations-employee.jpg" >
</div>
...
<script> var product_details ="Corporate Employee Gifts - Savory Flavors <br/>"; </script>
