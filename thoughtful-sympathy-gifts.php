...
<!-- End Google Tag Manager (noscript) -->
    ...
    <?php echo breadCrumb($app_path, "Thoughtful Sympathy Gifts", 2, "sympathy-gift-baskets", "Sympathy Gift Baskets");?>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 038</p>
 ...
 <div class="product-metadata" 
    data-product-id="product-038"
    data-product-name="Thoughtful Sympathy Gifts"
    ...
    data-product-qty=""
    data-product-cart_img="unique-sympathy-gifts.jpg" >
</div>
...
<script> var product_details ="Thoughtful Sympathy Gifts - Traditions<br/>"; </script>
