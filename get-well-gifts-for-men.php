...
<!-- End Google Tag Manager (noscript) -->
    ...
    <?php echo breadCrumb($app_path, "Get Well Gifts for Men", 2, "get-well-gift-baskets.php", "Get Well Gift Baskets");?>
...
<section id="" class="mb-5">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 045</p>
                    <h3 class="prod-title">Basket of Treats</h3>
                      <span class="price">
                ...
                <div class="col-sm-12 mt-5">
                    ...
                    <h2 class="cgb-subhead">Get Well Gifts for Men & Women</h2>
 ...
 <div class="product-metadata" 
    ...
    data-product-name="Get Well Gifts for Men"
    data-product-price-regular="59.50"
    data-product-shipping-price="18.25"
    ...
    data-product-qty=""
    data-product-cart_img="get-well-delivery.jpg" >
</div>
...
<script> var product_details ="Get Well Gifts for Men - Basket of Treats<br/>"; </script>
