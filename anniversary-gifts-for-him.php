...
<?php echo breadCrumb($app_path, "Anniversary Gifts for Him", 2, "anniversary-gift-ideas.php", "Anniversary Gift Ideas");?>
<section id="" class="mb-5">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 063</p>
                    <h3 class="prod-title">"Lancaster Favorites" Anniversary Gift</h3>
                      <span class="price">
 ...
 <div class="product-metadata" 
    data-product-id="product-063"
    data-product-name="Anniversary Gifts for Him"
    ...
    data-product-qty=""
    data-product-cart_img="assets/images/products/lancaster-favorites/anniversary-gifts-ideas.jpg" >
</div>
...
<script> var product_details ="Anniversary Gifts for Him - Lancaster Favorites <br/>"; </script>
