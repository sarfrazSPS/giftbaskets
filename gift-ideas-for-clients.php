...
<?php echo breadCrumb($app_path, "Gift Ideas for Clients", 2, "corporate-gifts.php", "Corporate Gifts");?>
<section id="" class="mb-5">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 061</p>
 ...
 <div class="product-metadata" 
    ...
    data-product-qty=""
    data-product-cart_img="get-well.jpg" >
</div>
