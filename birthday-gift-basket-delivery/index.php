            ...
            <div class="row mt-3">
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/product11.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Happy Birthday Sweet and Savory Gift Box</h5>
                            ...
                            <span class="product-price mt-1">$79.99</span>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/product22.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Happy Birthday Sweet and Savory Gift Box</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
