            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/basket-of-treats/congratulations-food-basket.jpg" class="card-img-top" alt="..." loading="lazy" />
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Congratulations Food Basket</h5>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/chocolate-lovers/congratulations-chocolate-gifts.jpg" class="card-img-top" alt="..." loading="lazy" />
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Congratulations Chocolate Gifts</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/traditions/congratulations-gift-basket.jpg" class="card-img-top" alt="..." loading="lazy" />
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Congratulations Gift Basket</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/savory-flavors/congratulations-gift.jpg" class="card-img-top" alt="..." loading="lazy" />
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Congratulations Gifts</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                ...
                <div class="col col-sm-6 col-md-4 col-lg-3 mt-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/dutch-traditions/congratulations-gifts-delivered.jpg" class="card-img-top" alt="..." loading="lazy" />
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">"Deluxe Traditions" Congratulations</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
