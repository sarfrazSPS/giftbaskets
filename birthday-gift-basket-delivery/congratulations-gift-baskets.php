    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/basket-of-treats/congratulations-food-basket.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/chocolate-lovers/congratulations-chocolate-gifts.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/traditions/congratulations-gift-basket.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/savory-flavors/congratulations-gift.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/dutch-traditions/congratulations-gifts-delivered.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
