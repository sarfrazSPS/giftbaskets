        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/basket-of-treats/get-well-delivery.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Get Well Delivery Basket</h5>
                            ...
                            <div class="product-metadata" 
                                data-product-id="product-1040"
                                data-product-name="Get Well Delivery Basket"
                                ...
                                data-product-image-1="get-well-delivery.jpg"
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Get Well Soon Gifts</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/lancaster-favorites/get-well-gift-basket.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <div class="product-metadata" 
                                ...
                                data-product-flavor-pie="yes"
                                data-product-flavor-bread="yes"
                                data-product-image-1="get-well-gift-basket.jpg"
                                data-product-image-2=""
                                data-product-image-3=""
                                data-product-image-4=""
                                ></div>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/savory-flavors/unique-get-well-gifts.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Unique Get Well Gifts</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                                ...
                                <a class="mt-2 ps-2">123 Reviews</a>
                            ...
                            <!-- images must be on root path in the folder "images" -->
                            <div class="product-metadata" 
                                data-product-id="product-1042"
                                data-product-name="Unique Get Well Gifts"
                                data-product-price-regular="119.50"
                                data-product-price-sale=""
                                data-product-shipping-price="0"
                                data-product-stars="5"
                                data-product-reviews="123"
                                data-product-flavor-pie="yes"
                                data-product-flavor-bread="yes"
                                data-product-image-1="unique-get-well-gifts.jpg"
                                data-product-image-2=""
                                data-product-image-3=""
                                data-product-image-4=""
                                ></div>
            ...
            <div class="row mt-4">
                <div class="col col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/bakers-special/get-well-gifts.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Get Well Gifts</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                            ...
                            <div class="product-metadata" 
                                ...
                                data-product-flavor-pie="yes"
                                data-product-flavor-bread="yes"
                                data-product-image-1="get-well-gifts.jpg"
                                data-product-image-2=""
                                data-product-image-3=""
                                data-product-image-4=""
                                ></div>
                ...
                <div class="col col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/bakers-choice/get-well-soon-gift-basket.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Bakers Get Well Gift</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                            ...
                            <!-- images must be on root path in the folder "images" -->
                            <div class="product-metadata" 
                                data-product-id="product-1044"
                                data-product-name="Bakers Get Well Gift"
                                ...
                                data-product-flavor-pie="yes"
                                data-product-flavor-bread="yes"
                                data-product-image-1="get-well-soon-gift-basket.jpg"
                                data-product-image-2=""
                                data-product-image-3=""
                                data-product-image-4=""
                                ></div>
