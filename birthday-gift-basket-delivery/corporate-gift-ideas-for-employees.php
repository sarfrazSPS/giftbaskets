            ...
            <div class="row mt-3">
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Corporate Gifts</h5>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Employee Thank You Gift Basket</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Employee Birthday Gift</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
            ...
            <div class="row mt-4">
                <div class="col">
                    <div class="card bg-card">
                        ...
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Savory Flavors Congratulations</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
                ...
                <div class="col">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/traditions/employee-get-well.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="favs-cat mt-0 mb-0">Employee Get Well Gift</h5>
                            <div class="d-flex align-items-center">
                                <div class="mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path
