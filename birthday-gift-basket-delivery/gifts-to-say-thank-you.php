            ...
            <div class="row mt-3">
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/basket-of-treats/thank-you-gifts-delivered.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card bg-card">
                        <img src="<?=$app_path;?>assets/images/products/lancaster-favorites/thank-you-gifts.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
