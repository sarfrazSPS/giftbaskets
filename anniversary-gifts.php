...
<!-- End Google Tag Manager (noscript) -->    
    ...
    <?php echo breadCrumb($app_path, "Anniversary Gifts", 2, "anniversary-gift-ideas.php", "Anniversary Gift Ideas");?>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: 065</p>
 ...
 <div class="product-metadata" 
    data-product-id="product-065"
    data-product-name="Anniversary Gifts"
    ...
    data-product-qty=""
    data-product-cart_img="best-anniversary-gift.jpg" >
</div>
