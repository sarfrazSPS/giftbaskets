...
$pname = "Get Well Soon Gifts - Traditions";
...
$pimg1 = "unique-get-well-gifts.jpg";
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-2 small-images-outer">
                            ...
                            <!--4 side images -->
                                ...
                                <img
                                class="img-responsive"
                                src="assets/images/products/savory-flavors/unique-get-well-gifts.jpg"
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Main images -->
                                    ...
                                    <img  src="assets/images/products/savory-flavors/unique-get-well-gifts.jpg"   alt="Get well gift baskets can lift the spirits of those feeling under the weather. Our Amish baked goods, gourmet foods and more are loved by everyone"      id="image_box" class="img-responsive"  />
                ...
                <div class="col-md-6">
                    <p class="prod-id">Product ID: product-049</p>
                    <h3 class="prod-title">Get Well Soon Gifts</h3>
                      <span class="price">
